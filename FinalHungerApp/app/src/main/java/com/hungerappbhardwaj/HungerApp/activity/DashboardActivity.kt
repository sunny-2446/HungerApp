...
import com.hungerappbhardwaj.HungerApp.fragment.*
import com.hungerappbhardwaj.HungerApp.fragment.RestaurantFragment.Companion.resId
import com.hungerappbhardwaj.HungerApp.util.DrawerLocker
import com.hungerappbhardwaj.HungerApp.util.SessionManager
        ...
        navigationView.setNavigationItemSelectedListener { item: MenuItem ->
            ...
            * We delay it by 0.1 second*/
            ...
            when (item.itemId) {
                ...
                R.id.order_history -> {
                    val orderHistoryFragment = OrderHistory()
